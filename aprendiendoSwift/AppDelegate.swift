...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didRegisterUserNotificationSettings notificationsSettings: UIUserNotificationSettings) {
        print ("tipos de notificaciones aceptadas \(notificationsSettings.types)")
    }
